...
- Styling: `assets/dialog.qss` is applied, including TODO input-frame and row styles.
...
- Persistence: `modules/ui_utils/todo_state.py` stores JSON under `AppData/` using atomic writes.
...
- `assets/dialog.qss`: TODO input-frame styling and compact row/delete-button styling.
