...
Additional behavior:
- If a dialog throws an unexpected exception (hard-fail), `DialogWrapper` logs details to `live_logs/error.log` and shows a short StatusBar hint after overlay/scanner cleanup.
